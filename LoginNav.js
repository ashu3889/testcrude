    ...
    let count = 1;
		export  class LoginNav extends Component{
			...
			componentDidMount(){
                 ...
                 //alert( this.getUrlParameter('request_token')); 
            ...
            startGeneratingServerSession(){
              this.props.getAcessToken('ypmxayteat7agml9','0ob46jtno6x3vqixhkmn5ok5qhp1eyax',this.state.token);
            }
  ...
  var NseCM = 1,
    ...
    this.connect = function() {
      ...
      //var self  = this;
              ...
              var ws = new WebSocket(`${WSS_ROOT_URL}${accessdata}`);
              //alert(accessdata);
