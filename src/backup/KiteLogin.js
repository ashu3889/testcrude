    ...
    import {getAcessToken ,addTickDataTest, pivotDataTest} from '../action/action.js';
    ...
    //code to set and get the data   */ 
        ...
        //alert(JSON.stringify(this.props.tickCom));
		    ...
		    return(
             ...
             <button onClick = {() => this.startfetchingdata()} >Call Websocket client</button>
  ...
  function mapStateToProps(state){
     ...
     export default connect(mapStateToProps,{addTickDataTest,pivotDataTest})(KiteLogin);
